...
export const EditProfile: FC<ProfileProps> = ({
    ...
    const linkTiktokAccount = (): void => {
        window.location.href =
            `https://ads.tiktok.com/marketing_api/auth?app_id=${process.env.REACT_APP_CLERK_TKT_MARKETING_APP_ID}&state=your_custom_params&redirect_uri=${encodeURI(process.env.REACT_APP_URL + 'branddashboard' || '')}&rid=8w8cll1xcbs`;
    };
