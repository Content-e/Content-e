      ...
      <section>
        ...
        <div className="creator-dashboard__text-wrapper">
            ...
            {windowSize <= 991 && mobileDetailsOpened ? (
              <>
                <p>
                  ...
                  clearly defined target audience. It's essential that a
                  creative team or third-party agency understand who they're
                  trying to reach to encourage them to take action. Depending on
                  the amount of data you hold about your audience, you may have
                  detailed personas or primary and secondary audiences. Provide
                  as much detail as possible, enabling your team to gain an
          ...
          {windowSize <= 991 && mobileDetailsOpened ? (
            <div className="creator-dashboard__text dark short-gap">
              <p>
                The budget is crucial information as it lets creative teams
                assess the scale that the project can reach and ensures that
                they pitch ideas within the company's financial resources. It's
                inadvisable to allow marketing teams to use the budget as they
                wish because projects always have a specific fiscal limit. Teams
                can use their time and resources efficiently if they understand
                the budgetary constraints of the campaign.
              </p>
              <p>
                ...
                guide that you can share. Describe the tone of voice for
                previous marketing campaigns and communications to ensure that
                the team's work aligns with the established company image.
              </p>
              <p>
